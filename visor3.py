...
# Agregar una imagen como título
image_path = r"C:\Users\Leo García Zavala\Downloads\titulo.png"  # Ruta de la imagen
if os.path.exists(image_path):
    title_image = tk.PhotoImage(file=image_path)
    label_title = tk.Label(window, image=title_image)
...
subir_pdf_image = tk.PhotoImage(file=r"C:\Users\Leo García Zavala\Downloads\subirpdf.png")

# Agregar un botón con la imagen para seleccionar el archivo PDF y realizar la conversión
btn_convertir = tk.Button(window, image=subir_pdf_image, command=convertir_a_audio, bd=0)
btn_convertir.pack(pady=20)

# Cargar las imágenes de los botones "Pausar" y "Reanudar"
pausar_image = tk.PhotoImage(file=r"C:\Users\Leo García Zavala\Downloads\pause.png")
reanudar_image = tk.PhotoImage(file=r"C:\Users\Leo García Zavala\Downloads\play.png")

# Agregar botones con las imágenes para pausar y reanudar la reproducción
btn_pause = tk.Button(window, image=pausar_image, state=tk.DISABLED, command=pausar_reproduccion, bd=0)
btn_pause.pack(pady=10)

btn_resume = tk.Button(window, image=reanudar_image, state=tk.DISABLED, command=reanudar_reproduccion, bd=0)
